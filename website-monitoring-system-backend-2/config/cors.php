...
return [
    'paths' => ['api/*', 'sanctum/csrf-cookie','register','websites', 'login', 'mroles', 'monitoring-logs/*', 'user' , 'dashboard', 'users','add-website', 'monitoring-logs', 'manage-users', 'manage-users/*'], // allow API and CSRF routes
